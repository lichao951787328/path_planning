...
// 这是一个点云预处理程序，用于将全局地图中的点云进行滤波和分割，提取出平面部分，并将平面部分高度小于5cm的点删除。得到杂乱的PCD
// 后续再去cloudcompare里将点云中的一些噪点删除得到clearPCD
int main(int argc, char **argv)
{
    ...
    cloud_above_plane->height = 1;
    cloud_above_plane->width = cloud_above_plane->points.size();
    ...
    pcl::io::savePCDFileASCII("/home/lichao/catkin_pathplanning/src/path_planning/data/dirtyPCD.pcd", *cloud_above_plane);
